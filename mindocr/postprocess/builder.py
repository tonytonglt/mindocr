...
from .det_drrg_postprocess import *
from .rec_postprocess import *
from . import det_db_postprocess
from . import det_pse_postprocess
from . import det_east_postprocess
from . import det_drrg_postprocess
from . import rec_postprocess

__all__ = ["build_postprocess"]

supported_postprocess = (
    det_db_postprocess.__all__ + det_pse_postprocess.__all__ + det_east_postprocess.__all__ + det_drrg_postprocess.__all__ + rec_postprocess.__all__
)
