import inspect
from .det_loss import L1BalancedCELoss, PSEDiceLoss, EASTLoss, DRRGLoss
from .rec_loss import CTCLoss, AttentionLoss

__all__ = ['build_loss']

supported_losses = ['L1BalancedCELoss', 'CTCLoss', 'AttentionLoss', 'PSEDiceLoss', 'EASTLoss', 'DRRGLoss']
