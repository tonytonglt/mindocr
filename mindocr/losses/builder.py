import inspect
from .det_loss import L1BalancedCELoss, EastLoss
from .rec_loss import CTCLoss, AttentionLoss, SARLoss

__all__ = ['build_loss']

supported_losses = ['L1BalancedCELoss', 'CTCLoss', 'AttentionLoss', 'EastLoss', 'SARLoss']
